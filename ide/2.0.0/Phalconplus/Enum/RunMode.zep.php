...
class RunMode extends AbstractEnum
{
    ...
    protected $mapClasses = ['Web' => 'Web', 'Cli' => 'Cli', 'Srv' => 'Srv', 'Micro' => 'Micro'];


    protected $scripts = ['Web' => '/default-web.php', 'Cli' => '/default-cli.php', 'Srv' => '/default-web.php', 'Micro' => '/default-micro.php'];
