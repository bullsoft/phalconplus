...
PHP_METHOD(PhalconPlus_Logger_Formatter_LinePlus, getProcessor) {
	...
	_3 = zephir_fetch_nproperty_this(this_ptr, SL("processors"), PH_NOISY_CC);
...
PHP_METHOD(PhalconPlus_Logger_Formatter_LinePlus, __get) {
	...
	_1 = zephir_fetch_nproperty_this(this_ptr, SL("processors"), PH_NOISY_CC);
	ZEPHIR_OBS_VAR(_2);
