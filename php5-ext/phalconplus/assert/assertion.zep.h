...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalconplus_assert_assertion_noteq, 0, 0, 2)
	ZEND_ARG_INFO(0, value1)
	ZEND_ARG_INFO(0, value2)
	ZEND_ARG_INFO(0, message)
	ZEND_ARG_INFO(0, propertyPath)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalconplus_assert_assertion_range, 0, 0, 3)
	ZEND_ARG_INFO(0, value)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalconplus_assert_assertion_min, 0, 0, 2)
	ZEND_ARG_INFO(0, value)
	ZEND_ARG_INFO(0, minValue)
	ZEND_ARG_INFO(0, message)
	ZEND_ARG_INFO(0, propertyPath)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalconplus_assert_assertion_max, 0, 0, 2)
	ZEND_ARG_INFO(0, value)
	ZEND_ARG_INFO(0, maxValue)
	ZEND_ARG_INFO(0, message)
	ZEND_ARG_INFO(0, propertyPath)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalconplus_assert_assertion_isstring, 0, 0, 1)
	ZEND_ARG_INFO(0, value)
	ZEND_ARG_INFO(0, message)
	ZEND_ARG_INFO(0, propertyPath)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_phalconplus_assert_assertion_isarray, 0, 0, 1)
	ZEND_ARG_INFO(0, value)
	ZEND_ARG_INFO(0, message)
	ZEND_ARG_INFO(0, propertyPath)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_phalconplus_assert_assertion_isjsonstring, 0, 0, 1)
	ZEND_ARG_INFO(0, value)
	ZEND_ARG_INFO(0, message)
	ZEND_ARG_INFO(0, propertyPath)
ZEND_END_ARG_INFO()
