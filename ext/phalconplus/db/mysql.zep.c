	...
	while (1) {
		...
		if (EG(exception)) {
			...
			if (zephir_instance_of_ev(e, zend_exception_get_default(TSRMLS_C) TSRMLS_CC)) {
				...
				ZEPHIR_CALL_FUNCTION(NULL, "error_log", &_9, 48, _8$$5);
				zephir_check_call_status();
				...
				if (ZEPHIR_GT_LONG(tryTimes, 0)) {
					...
					ZEPHIR_CALL_FUNCTION(NULL, "usleep", &_12, 49, _11$$6);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_FUNCTION(NULL, "error_log", &_9, 48, _16$$6);
					zephir_check_call_status();
				} else {
					...
					ZEPHIR_CALL_FUNCTION(NULL, "error_log", &_9, 48, _19$$7);
					zephir_check_call_status();
