...
PHP_METHOD(PhalconPlus_Base_Exception, __construct) {
	...
	zend_bool _14, _17, _30;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zephir_fcall_cache_entry *_3 = NULL, *_13 = NULL;
	zend_long code, ZEPHIR_LAST_CALL_STATUS;
	zval *info, info_sub, *code_param = NULL, message, args, _0, _12, _15, _16, _18, _19, _20, _21, showMessage, _28, cnt, _32, _34, _1$$4, _2$$4, _4$$4, _5$$5, _6$$5, _7$$5, _8$$6, _9$$6, _10$$6, _11$$7, logger$$8, _22$$8, _23$$8, _24$$8, argsJson$$8, _25$$8, _26$$8, _27$$8, _29$$9, _31$$12, _33$$13;
	...
	if (_14) {
		ZEPHIR_CALL_CE_STATIC(&_15, phalconplus_enum_sys_ce, "app", &_13, 0);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_16, &_15, "di", NULL, 0);
		zephir_check_call_status();
		_14 = zephir_is_true(&_16);
	}
	_17 = _14;
	if (_17) {
		ZEPHIR_CALL_CE_STATIC(&_18, phalconplus_enum_sys_ce, "app", &_13, 0);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_19, &_18, "di", NULL, 0);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_21);
		ZVAL_STRING(&_21, "logger");
		ZEPHIR_CALL_METHOD(&_20, &_19, "has", NULL, 0, &_21);
		zephir_check_call_status();
		_17 = zephir_is_true(&_20);
	}
	if (_17) {
		ZEPHIR_CALL_CE_STATIC(&_22$$8, phalconplus_enum_sys_ce, "app", &_13, 0);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_23$$8, &_22$$8, "di", NULL, 0);
		zephir_check_call_status();
		...
		ZEPHIR_CONCAT_VSV(&_26$$8, &message, ", args: ", &argsJson$$8);
		ZEPHIR_CALL_METHOD(&_27$$8, this_ptr, "getlevel", NULL, 0);
		zephir_check_call_status();
	...
	ZVAL_STRING(&_21, "%s");
	ZEPHIR_CALL_FUNCTION(&cnt, "substr_count", NULL, 28, &showMessage, &_21);
	zephir_check_call_status();
