...
PHP_METHOD(PhalconPlus_Base_Model, findFirstOrEmpty) {
	...
	if (ZEPHIR_IS_FALSE(&record)) {
		...
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 65);
		zephir_check_call_status();
		RETURN_MM();
	}
	RETURN_CCTOR(&record);
...
PHP_METHOD(PhalconPlus_Base_Model, getMessage) {
	...
	if (zephir_fast_count_int(&_0)) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_2$$3, "current", NULL, 66, &_1$$3);
		zephir_check_call_status();
		zephir_get_strval(&_3$$3, &_2$$3);
		RETURN_CTOR(&_3$$3);
	}
...
PHP_METHOD(PhalconPlus_Base_Model, getFirstMessage) {
	...
	if (zephir_fast_count_int(&_0)) {
		...
		ZEPHIR_CALL_FUNCTION(&_2$$3, "reset", NULL, 67, &_1$$3);
		ZEPHIR_UNREF(&_1$$3);
		zephir_check_call_status();
		zephir_get_strval(&_3$$3, &_2$$3);
		RETURN_CTOR(&_3$$3);
...
PHP_METHOD(PhalconPlus_Base_Model, getLastMessage) {
	...
	if (zephir_fast_count_int(&_0)) {
		...
		zephir_check_call_status();
		ZEPHIR_MAKE_REF(&_1$$3);
		ZEPHIR_CALL_FUNCTION(&_2$$3, "end", NULL, 68, &_1$$3);
		ZEPHIR_UNREF(&_1$$3);
		zephir_check_call_status();
		zephir_get_strval(&_3$$3, &_2$$3);
		RETURN_CTOR(&_3$$3);
