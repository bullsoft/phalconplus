...
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalconplus_base_protoorderby_getproperty, 0, 0, IS_STRING, NULL, 0)
#endif
ZEND_END_ARG_INFO()
...
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalconplus_base_protoorderby_setproperty, 0, 1, IS_OBJECT, "PhalconPlus\\Base\\ProtoOrderBy", 0)
#endif
#if PHP_VERSION_ID >= 70200
...
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalconplus_base_protoorderby_setdirection, 0, 1, IS_OBJECT, "PhalconPlus\\Base\\ProtoOrderBy", 0)
#endif
...
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalconplus_base_protoorderby_setalias, 0, 1, IS_OBJECT, "PhalconPlus\\Base\\ProtoOrderBy", 0)
#endif
#if PHP_VERSION_ID >= 70200
...
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalconplus_base_protoorderby_getdirection, 0, 0, IS_OBJECT, "PhalconPlus\\Enum\\OrderByDirection", 0)
#endif
ZEND_END_ARG_INFO()
...
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalconplus_base_protoorderby_getalias, 0, 0, IS_STRING, NULL, 0)
#endif
ZEND_END_ARG_INFO()
