...
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalconplus_base_simplerequest_softclone, 0, 1, IS_OBJECT, "PhalconPlus\\Base\\ProtoBuffer", 0)
#endif
...
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalconplus_base_simplerequest_getselfvars, 0, 0, IS_ARRAY, NULL, 0)
#endif
ZEND_END_ARG_INFO()
...
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalconplus_base_simplerequest___unset, 0, 1, IS_VOID, NULL, 0)
#endif
#else
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalconplus_base_simplerequest___unset, 0, 0, 1)
#define arginfo_phalconplus_base_simplerequest___unset NULL
#endif
...
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalconplus_base_simplerequest_isempty, 0, 0, _IS_BOOL, NULL, 0)
#endif
ZEND_END_ARG_INFO()
