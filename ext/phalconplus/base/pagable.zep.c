...
PHP_METHOD(PhalconPlus_Base_Pagable, setOrderBy) {
	...
	ZEPHIR_MAKE_REF(&_0);
	ZEPHIR_CALL_FUNCTION(NULL, "array_push", NULL, 49, &_0, orderBy);
	ZEPHIR_UNREF(&_0);
	...
	if (Z_TYPE_P(&orderBys) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&orderBys), _0)
		{
			...
			if (_2$$3) {
				...
				ZEPHIR_CALL_METHOD(NULL, &orderBy$$4, "setproperty", &_5, 50, &_4$$4);
				zephir_check_call_status();
				...
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(NULL, &orderBy$$4, "setdirection", &_8, 51, &direction$$4);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (_10$$5) {
					...
					ZEPHIR_CALL_METHOD(NULL, &orderBy$$6, "setproperty", &_5, 50, &_12$$6);
					zephir_check_call_status();
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(NULL, &orderBy$$6, "setdirection", &_8, 51, &direction$$6);
					zephir_check_call_status();
