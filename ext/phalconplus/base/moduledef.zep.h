...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalconplus_base_moduledef_mount, 0, 0, 1)
...
ZEPHIR_INIT_FUNCS(phalconplus_base_moduledef_method_entry) {
	...
	PHP_ME(PhalconPlus_Base_ModuleDef, mount, arginfo_phalconplus_base_moduledef_mount, ZEND_ACC_PUBLIC)
