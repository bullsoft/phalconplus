...
PHP_METHOD(PhalconPlus_Base_ModuleDef, __construct) {
	...
	zval moduleDir, _2$$3;
	zval *boot, boot_sub, *moduleDir_param = NULL, _0, _3, _5, _6, _7, appConfig, _8, _9, _10, _11, _12, _13, _14, _15, _16, _17, _18, _20, _21, _22, _1$$3, _23$$4, _24$$4, _25$$4;
	...
	ZEPHIR_MM_GROW();
	zephir_fetch_params(1, 2, 0, &boot, &moduleDir_param);
	...
	ZEPHIR_CALL_FUNCTION(&_0, "is_dir", NULL, 35, &moduleDir);
	...
	if (!(zephir_is_true(&_0))) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$3, "phalconplus/Base/ModuleDef.zep", 39 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	...
	ZEPHIR_CALL_METHOD(&_6, boot, "load", NULL, 36, &_7);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(NULL, &_10, "__construct", NULL, 37, &_11);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_22, "is_file", NULL, 38, &_21);
	zephir_check_call_status();
	if (!(zephir_is_true(&_22))) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_23$$4, "phalconplus/Base/ModuleDef.zep", 58 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(PhalconPlus_Base_ModuleDef, impl) {
	...
	if (!(zephir_class_exists(&_1, 1 TSRMLS_CC))) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_2$$3, "phalconplus/Base/ModuleDef.zep", 66 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
