...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalconplus_mvc_psrapplication___construct, 0, 0, 0)
...
ZEPHIR_INIT_FUNCS(phalconplus_mvc_psrapplication_method_entry) {
	...
	PHP_ME(PhalconPlus_Mvc_PsrApplication, mapHeaders, arginfo_phalconplus_mvc_psrapplication_mapheaders, ZEND_ACC_PROTECTED)
	PHP_FE_END
};
