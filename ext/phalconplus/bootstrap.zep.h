...
ZEPHIR_INIT_FUNCS(phalconplus_bootstrap_method_entry) {
	...
	PHP_ME(PhalconPlus_Bootstrap, regModule, arginfo_phalconplus_bootstrap_regmodule, ZEND_ACC_PRIVATE)
	...
	PHP_ME(PhalconPlus_Bootstrap, getDebug, NULL, ZEND_ACC_PUBLIC)
