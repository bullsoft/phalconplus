...
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalconplus_facades_abstractfacade_app, 0, 0, IS_OBJECT, "PhalconPlus\\App\\App", 0)
#endif
ZEND_END_ARG_INFO()
...
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalconplus_facades_abstractfacade_getapp, 0, 0, IS_OBJECT, "PhalconPlus\\App\\App", 0)
#endif
ZEND_END_ARG_INFO()
