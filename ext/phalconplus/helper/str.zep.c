...
PHP_METHOD(PhalconPlus_Helper_Str, decodeJson) {
	...
	array_init(&_0);
	ZVAL_LONG(&_1, 2);
	ZEPHIR_CALL_METHOD(NULL, &obj, "__construct", NULL, 77, &_0, &_1);
	...
	ZEPHIR_RETURN_CALL_METHOD(&obj, "getarraycopy", NULL, 128);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(PhalconPlus_Helper_Str, startsWith) {
	...
	ZEPHIR_CALL_FUNCTION(&_2, "mb_substr", NULL, 129, &full, &_0, &_1);
	zephir_check_call_status();
...
PHP_METHOD(PhalconPlus_Helper_Str, endsWith) {
	...
	ZEPHIR_CALL_FUNCTION(&_1, "mb_substr", NULL, 129, &full, &_0);
	zephir_check_call_status();
...
PHP_METHOD(PhalconPlus_Helper_Str, contains) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "mb_substr_count", NULL, 130, &full, &partial);
	zephir_check_call_status();
...
PHP_METHOD(PhalconPlus_Helper_Str, safeBase64Encode) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "base64_encode", NULL, 131, &inputStr);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "+/");
	ZEPHIR_INIT_VAR(&_2);
...
PHP_METHOD(PhalconPlus_Helper_Str, safeBase64Decode) {
	...
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_FUNCTION("base64_decode", NULL, 132, &_2);
	zephir_check_call_status();
	RETURN_MM();
