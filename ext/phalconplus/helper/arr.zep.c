...
PHP_METHOD(PhalconPlus_Helper_Arr, firstKey) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "reset", NULL, 69, inputArray);
...
PHP_METHOD(PhalconPlus_Helper_Arr, first) {
	...
	zephir_check_call_status();
	ZEPHIR_MAKE_REF(inputArray);
	ZEPHIR_RETURN_CALL_FUNCTION("reset", NULL, 69, inputArray);
	ZEPHIR_UNREF(inputArray);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(PhalconPlus_Helper_Arr, last) {
	...
	zephir_check_call_status();
	ZEPHIR_MAKE_REF(inputArray);
	ZEPHIR_RETURN_CALL_FUNCTION("end", NULL, 70, inputArray);
	ZEPHIR_UNREF(inputArray);
	zephir_check_call_status();
	RETURN_MM();
