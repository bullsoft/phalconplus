...
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalconplus_rpc_yar_setserver, 0, 1, IS_OBJECT, "PhalconPlus\\Rpc\\AbstractYar", 0)
#endif
...
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalconplus_rpc_yar_handle, 0, 0, _IS_BOOL, NULL, 0)
#endif
ZEND_END_ARG_INFO()
...
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalconplus_rpc_yar_defaultresponse, 0, 0, IS_STRING, NULL, 0)
#endif
