...
PHP_METHOD(PhalconPlus_RPC_Client_Adapter_Local, callByParams) {
	...
	if (zephir_is_callable(_5 TSRMLS_CC)) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "error_log", &_7, 46, _6$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(_8$$3);
		ZEPHIR_CONCAT_SV(_8$$3, "InvokeMethod: ", method);
		ZEPHIR_CALL_FUNCTION(NULL, "error_log", &_7, 46, _8$$3);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(NULL, "error_log", &_7, 46, _10$$3);
		zephir_check_call_status();
...
PHP_METHOD(PhalconPlus_RPC_Client_Adapter_Local, callByObject) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "error_log", &_2, 46, _1);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(NULL, "error_log", &_2, 46, &_9);
	zephir_check_call_status();
