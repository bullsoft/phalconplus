...
PHP_METHOD(PhalconPlus_RPC_Client_Adapter_Local, callByParams) {
	...
	if (zephir_is_callable(&_8 TSRMLS_CC)) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "error_log", &_10, 62, &_9$$4);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_11$$4);
		ZEPHIR_CONCAT_SV(&_11$$4, "InvokeMethod: ", &method);
		ZEPHIR_CALL_FUNCTION(NULL, "error_log", &_10, 62, &_11$$4);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(NULL, "error_log", &_10, 62, &_13$$4);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(NULL, "error_log", &_10, 62, &_32$$4);
		zephir_check_call_status();
...
PHP_METHOD(PhalconPlus_RPC_Client_Adapter_Local, callByObject) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "error_log", &_2, 62, &_10);
	zephir_check_call_status();
