...
PHP_METHOD(PhalconPlus_RPC_Client_Adapter_Local, callByParams) {
	...
	int ZEPHIR_LAST_CALL_STATUS;
	zend_class_entry *_3;
	zval *service_param = NULL, *method_param = NULL, *request, *serviceClass, *serviceObj, *response, *_0 = NULL, *_1, *_2 = NULL, *_4, *_6, *_9 = NULL, *_10;
	...
	if (zephir_is_callable(_5 TSRMLS_CC)) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "error_log", &_7, 48, _8);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(_9);
		ZEPHIR_INIT_NVAR(_9);
		...
		ZEPHIR_CALL_FUNCTION(NULL, "error_log", &_7, 48, _10);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(_11);
...
PHP_METHOD(PhalconPlus_RPC_Client_Adapter_Local, callByObject) {
	...
	zval *rawData_param = NULL, *service = NULL, *method = NULL, *request, *_0 = NULL, *_1, *_3 = NULL, *_4 = NULL, _6;
	zval *rawData = NULL;
	...
	ZEPHIR_CALL_FUNCTION(NULL, "error_log", &_2, 48, _1);
	zephir_check_call_status();
	...
	if (!(zephir_array_isset_string_fetch(&service, rawData, SS("service"), 0 TSRMLS_CC))) {
		...
		ZEPHIR_CALL_METHOD(NULL, _3, "__construct", NULL, 8, _4);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(NULL, "error_log", &_2, 48, &_6);
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "callbyparams", NULL, 57, service, method, request);
	zephir_check_call_status();
	RETURN_MM();
