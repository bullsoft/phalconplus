...
PHP_METHOD(PhalconPlus_Rpc_Yar, __construct) {
	...
	if (ZEPHIR_IS_EQUAL(&_2, &formater)) {
		...
		ZEPHIR_CALL_FUNCTION(&_4$$4, "msgpack_unpack", NULL, 125, &rawBody);
		zephir_check_call_status();
...
PHP_METHOD(PhalconPlus_Rpc_Yar, handle) {
	...
	zval __$true, serviceName, _0, sampleCodes, expectedRet, _1, _2, _3, _4, _5, _36, _6$$3, _7$$3, _9$$3, _10$$3, _11$$3, _12$$3, _13$$3, _14$$3, _15$$3, e$$4, ret$$4, _16$$4, _31$$4, _32$$4, _33$$4, _34$$4, _35$$4, _17$$5, _20$$5, _24$$5, _25$$5, _26$$5, _18$$6, _19$$6, _21$$7, _22$$7, _23$$7, _27$$8, _28$$8, _29$$8, _30$$8;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *this_ptr = getThis();
	...
	if (zephir_is_true(&_3)) {
		...
		array_init(&_16$$4);
		zephir_array_update_string(&ret$$4, SL("data"), &_16$$4, PH_COPY | PH_SEPARATE);

		/* try_start_1: */

			zephir_read_property(&_17$$5, this_ptr, SL("requestArgs"), PH_NOISY_CC | PH_READONLY);
			if (ZEPHIR_IS_EMPTY(&_17$$5)) {
				ZEPHIR_INIT_VAR(&_18$$6);
				object_init_ex(&_18$$6, zend_exception_get_default(TSRMLS_C));
				ZEPHIR_INIT_VAR(&_19$$6);
				ZVAL_STRING(&_19$$6, "invalid request args");
				ZEPHIR_CALL_METHOD(NULL, &_18$$6, "__construct", NULL, 7, &_19$$6);
				zephir_check_call_status_or_jump(try_end_1);
				zephir_throw_exception_debug(&_18$$6, "phalconplus/RPC/Yar.zep", 56);
				goto try_end_1;

			}
			zephir_read_property(&_20$$5, this_ptr, SL("serviceObj"), PH_NOISY_CC | PH_READONLY);
			if (ZEPHIR_IS_EMPTY(&_20$$5)) {
				ZEPHIR_CALL_METHOD(&_21$$7, this_ptr, "getdi", NULL, 0);
				zephir_check_call_status_or_jump(try_end_1);
				ZEPHIR_INIT_VAR(&_23$$7);
				ZVAL_STRING(&_23$$7, "backendSrv");
				ZEPHIR_CALL_METHOD(&_22$$7, &_21$$7, "get", NULL, 0, &_23$$7);
				zephir_check_call_status_or_jump(try_end_1);
				zephir_update_property_zval(this_ptr, SL("serviceObj"), &_22$$7);
			}
			zephir_read_property(&_24$$5, this_ptr, SL("serviceObj"), PH_NOISY_CC | PH_READONLY);
			zephir_read_property(&_26$$5, this_ptr, SL("requestArgs"), PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CALL_METHOD(&_25$$5, &_24$$5, "callbyobject", NULL, 0, &_26$$5);
			zephir_check_call_status_or_jump(try_end_1);
			zephir_array_update_string(&ret$$4, SL("data"), &_25$$5, PH_COPY | PH_SEPARATE);

		try_end_1:

		if (EG(exception)) {
			ZEPHIR_INIT_NVAR(&_16$$4);
			ZVAL_OBJ(&_16$$4, EG(exception));
			Z_ADDREF_P(&_16$$4);
			if (zephir_instance_of_ev(&_16$$4, zend_exception_get_default(TSRMLS_C))) {
				zend_clear_exception(TSRMLS_C);
				ZEPHIR_CPY_WRT(&e$$4, &_16$$4);
				ZEPHIR_CALL_METHOD(&_27$$8, &e$$4, "getcode", NULL, 0);
				zephir_check_call_status();
				ZVAL_LONG(&_28$$8, 1);
				ZEPHIR_CALL_FUNCTION(&_29$$8, "max", NULL, 127, &_27$$8, &_28$$8);
				zephir_check_call_status();
				zephir_array_update_string(&ret$$4, SL("errorCode"), &_29$$8, PH_COPY | PH_SEPARATE);
				ZEPHIR_CALL_METHOD(&_30$$8, &e$$4, "getmessage", NULL, 0);
				zephir_check_call_status();
				zephir_array_update_string(&ret$$4, SL("errorMsg"), &_30$$8, PH_COPY | PH_SEPARATE);
			}
		}
		ZEPHIR_INIT_VAR(&_32$$4);
		ZVAL_STRING(&_32$$4, "logger");
		ZEPHIR_CALL_METHOD(&_31$$4, this_ptr, "__get", NULL, 0, &_32$$4);
		zephir_check_call_status();
		zephir_read_property(&_33$$4, &_31$$4, SL("logId"), PH_NOISY_CC | PH_READONLY);
		zephir_array_update_string(&ret$$4, SL("logId"), &_33$$4, PH_COPY | PH_SEPARATE);
		zephir_read_property(&_34$$4, this_ptr, SL("encoder"), PH_NOISY_CC | PH_READONLY);
		zephir_get_strval(&encoder$$4, &_34$$4);
		ZEPHIR_CALL_ZVAL_FUNCTION(&_35$$4, &encoder$$4, NULL, 0, &ret$$4);
		zephir_check_call_status();
		zephir_update_property_zval(this_ptr, SL("responseBody"), &_35$$4);
	}
	zephir_read_property(&_36, this_ptr, SL("responseBody"), PH_NOISY_CC | PH_READONLY);
	zend_print_zval(&_36, 0);
	ZEPHIR_MM_RESTORE();
