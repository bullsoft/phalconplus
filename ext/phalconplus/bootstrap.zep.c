...
PHP_METHOD(PhalconPlus_Bootstrap, __construct) {
	...
	zephir_nts_static zephir_fcall_cache_entry *_3 = NULL, *_6 = NULL, *_8 = NULL, *_11 = NULL, *_13 = NULL;
	zval *_0, *_1;
	zval *modulePath, *_2 = NULL, *_4 = NULL, *_5 = NULL, *env = NULL, _7 = zval_used_for_init, *_9, *debug, *_10, *_12 = NULL, _14 = zval_used_for_init, *_15, *_16, *_17, *_18, *_19, *_20, *_21, *_22;

	ZEPHIR_MM_GROW();
	zephir_fetch_params(1, 1, 0, &modulePath);
	...
	if (!(zephir_is_true(_2))) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(_4, "phalconplus/Bootstrap.zep", 32 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_SINIT_VAR(_7);
	...
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(_4);
	ZEPHIR_CALL_FUNCTION(&_12, "dirname", &_13, modulePath);
	zephir_check_call_status();
	ZEPHIR_SINIT_NVAR(_7);
	ZVAL_STRING(&_7, "/", 0);
	zephir_fast_trim(_4, _12, &_7, ZEPHIR_TRIM_RIGHT TSRMLS_CC);
	ZEPHIR_INIT_LNVAR(_5);
	ZEPHIR_CONCAT_VS(_5, _4, "/");
	ZEPHIR_SINIT_VAR(_14);
	ZVAL_STRING(&_14, "APP_ROOT_DIR", 0);
	ZEPHIR_CALL_FUNCTION(NULL, "define", &_11, &_14, _5, ZEPHIR_GLOBAL(global_true));
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(_15);
	ZEPHIR_GET_CONSTANT(_15, "APP_ROOT_DIR");
	ZEPHIR_INIT_VAR(_16);
	ZEPHIR_CONCAT_VS(_16, _15, "common/");
	ZEPHIR_SINIT_NVAR(_14);
	ZVAL_STRING(&_14, "APP_ROOT_COMMON_DIR", 0);
	ZEPHIR_CALL_FUNCTION(NULL, "define", &_11, &_14, _16, ZEPHIR_GLOBAL(global_true));
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(_17);
	ZEPHIR_GET_CONSTANT(_17, "APP_ROOT_COMMON_DIR");
	ZEPHIR_INIT_VAR(_18);
	ZEPHIR_CONCAT_VS(_18, _17, "config/");
	ZEPHIR_SINIT_NVAR(_14);
	ZVAL_STRING(&_14, "APP_ROOT_COMMON_CONF_DIR", 0);
	ZEPHIR_CALL_FUNCTION(NULL, "define", &_11, &_14, _18, ZEPHIR_GLOBAL(global_true));
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(_19);
	ZEPHIR_GET_CONSTANT(_19, "APP_ROOT_COMMON_DIR");
	ZEPHIR_INIT_VAR(_20);
	ZEPHIR_CONCAT_VS(_20, _19, "load/");
	ZEPHIR_SINIT_NVAR(_14);
	ZVAL_STRING(&_14, "APP_ROOT_COMMON_LOAD_DIR", 0);
	ZEPHIR_CALL_FUNCTION(NULL, "define", &_11, &_14, _20, ZEPHIR_GLOBAL(global_true));
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(_21);
	ZEPHIR_GET_CONSTANT(_21, "APP_ROOT_DIR");
	ZEPHIR_INIT_VAR(_22);
	ZEPHIR_CONCAT_VS(_22, _21, "public/");
	ZEPHIR_SINIT_NVAR(_14);
	ZVAL_STRING(&_14, "APP_ROOT_PUB_DIR", 0);
	ZEPHIR_CALL_FUNCTION(NULL, "define", &_11, &_14, _22, ZEPHIR_GLOBAL(global_true));
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(PhalconPlus_Bootstrap, setModule) {
	...
	zval *module_param = NULL, *actualKeys, *expectedKeys, *_0;
	zval *module = NULL;
	...
	ZEPHIR_INIT_VAR(actualKeys);
	zephir_array_keys(actualKeys, module TSRMLS_CC);
	ZEPHIR_INIT_VAR(expectedKeys);
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("module"), PH_NOISY_CC);
	zephir_array_keys(expectedKeys, _0 TSRMLS_CC);
	if (!ZEPHIR_IS_EQUAL(actualKeys, expectedKeys)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(zend_exception_get_default(TSRMLS_C), "Module is is not a legal module", "phalconplus/Bootstrap.zep", 65);
		return;
	}
...
PHP_METHOD(PhalconPlus_Bootstrap, initConf) {
	...
	if (!(zephir_is_true(_1))) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(_3, "phalconplus/Bootstrap.zep", 78 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_NVAR(_3);
	...
	if (!(zephir_is_true(_9))) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(_10, "phalconplus/Bootstrap.zep", 85 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	...
	ZEPHIR_OBS_VAR(_18);
	zephir_array_fetch_string(&_18, module, SL("mode"), PH_NOISY, "phalconplus/Bootstrap.zep", 92 TSRMLS_CC);
	zephir_array_fetch(&_17, _16, _18, PH_NOISY | PH_READONLY, "phalconplus/Bootstrap.zep", 92 TSRMLS_CC);
	ZEPHIR_INIT_LNVAR(_4);
	...
	ZEPHIR_OBS_VAR(_22);
	zephir_array_fetch_string(&_22, module, SL("mode"), PH_NOISY, "phalconplus/Bootstrap.zep", 93 TSRMLS_CC);
	zephir_array_fetch(&_21, _20, _22, PH_NOISY | PH_READONLY, "phalconplus/Bootstrap.zep", 93 TSRMLS_CC);
	ZEPHIR_INIT_VAR(_23);
	ZEPHIR_CONCAT_VSVS(_23, _19, "app/", _21, ".php");
	zephir_array_update_string(&module, SL("classPath"), &_23, PH_COPY | PH_SEPARATE);
	zephir_array_fetch_string(&_24, module, SL("mode"), PH_NOISY | PH_READONLY, "phalconplus/Bootstrap.zep", 96 TSRMLS_CC);
...
PHP_METHOD(PhalconPlus_Bootstrap, exec) {
	...
	zephir_array_fetch(&_2, _1, _3, PH_NOISY | PH_READONLY, "phalconplus/Bootstrap.zep", 107 TSRMLS_CC);
...
PHP_METHOD(PhalconPlus_Bootstrap, execModule) {
	...
	int ZEPHIR_LAST_CALL_STATUS;
	zval *uri = NULL, *moduleClass, *_0, *_1, *_2, *_3, *_4, *_6, *_7 = NULL, *_8, *_9, *_10, *module, *_11 = NULL, *_13, *_14, *_15 = NULL, *_16 = NULL, *router = NULL, *newUri, *_17, *_18, *_19 = NULL, *_20 = NULL;
	...
	ZEPHIR_CALL_METHOD(NULL, _6, "setshared", NULL, _7, this_ptr);
	zephir_check_temp_parameter(_7);
	zephir_check_call_status();
	_8 = zephir_fetch_nproperty_this(this_ptr, SL("module"), PH_NOISY_CC);
	zephir_array_fetch_string(&_9, _8, SL("classPath"), PH_NOISY | PH_READONLY, "phalconplus/Bootstrap.zep", 123 TSRMLS_CC);
	...
	zephir_array_fetch_string(&moduleClass, _10, SL("className"), PH_NOISY, "phalconplus/Bootstrap.zep", 125 TSRMLS_CC);
	ZEPHIR_INIT_VAR(module);
	...
	if (zephir_has_constructor(module TSRMLS_CC)) {
		...
		ZEPHIR_CALL_METHOD(NULL, module, "__construct", NULL, _13);
		zephir_check_call_status();
	}

	/* try_start_1: */

		_14 = zephir_fetch_nproperty_this(this_ptr, SL("application"), PH_NOISY_CC);
		ZEPHIR_CALL_METHOD(&_15, _14, "handle", NULL, uri);
		zephir_check_call_status_or_jump(try_end_1);
		ZEPHIR_CALL_METHOD(&_16, _15, "getcontent", NULL);
		zephir_check_call_status_or_jump(try_end_1);
		zend_print_zval(_16, 0);
	...
	if (EG(exception)) {
		...
		if (zephir_instance_of_ev(_7, zephir_get_internal_ce(SS("phalcon\\mvc\\application\\exception") TSRMLS_CC) TSRMLS_CC)) {
			...
			ZEPHIR_INIT_VAR(_17);
			ZVAL_STRING(_17, "router", ZEPHIR_TEMP_PARAM_COPY);
			ZEPHIR_CALL_METHOD(&router, _14, "get", NULL, _17);
			zephir_check_temp_parameter(_17);
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&_15, router, "getdefaultmodule", NULL);
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&_16, router, "getrewriteuri", NULL);
			zephir_check_call_status();
			ZEPHIR_INIT_VAR(newUri);
			ZEPHIR_CONCAT_SVV(newUri, "/", _15, _16);
			_18 = zephir_fetch_nproperty_this(this_ptr, SL("application"), PH_NOISY_CC);
			ZEPHIR_CALL_METHOD(&_19, _18, "handle", NULL, newUri);
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&_20, _19, "getcontent", NULL);
			zephir_check_call_status();
			zend_print_zval(_20, 0);
		}
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(PhalconPlus_Bootstrap, load) {
	...
	zval *filePath, *rootPath = NULL, *loader = NULL, *config = NULL, *application = NULL, *bootstrap = NULL, *di = NULL, *_0, *_1 = NULL;
	...
	ZEPHIR_GET_CONSTANT(rootPath, "APP_ROOT_DIR");
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("loader"), PH_NOISY_CC);
	ZEPHIR_CPY_WRT(loader, _0);
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("config"), PH_NOISY_CC);
	ZEPHIR_CPY_WRT(config, _0);
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("application"), PH_NOISY_CC);
	ZEPHIR_CPY_WRT(application, _0);
	ZEPHIR_CPY_WRT(bootstrap, this_ptr);
