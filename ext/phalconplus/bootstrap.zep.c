...
PHP_METHOD(PhalconPlus_Bootstrap, __construct) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "is_dir", NULL, 33, modulePath);
	...
	ZEPHIR_CALL_FUNCTION(&env, "get_cfg_var", NULL, 34, &_3);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(NULL, "define", &_6, 35, &_3, _5, ZEPHIR_GLOBAL(global_true));
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(_7);
	ZEPHIR_SINIT_NVAR(_3);
	ZVAL_STRING(&_3, "/", 0);
	...
	ZEPHIR_CALL_FUNCTION(NULL, "define", &_6, 35, &_9, _8, ZEPHIR_GLOBAL(global_true));
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(_10);
	ZEPHIR_CALL_FUNCTION(&_11, "dirname", NULL, 36, modulePath);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(NULL, "define", &_6, 35, &_13, _12, ZEPHIR_GLOBAL(global_true));
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(_14);
	...
	ZEPHIR_CALL_FUNCTION(NULL, "define", &_6, 35, &_13, _15, ZEPHIR_GLOBAL(global_true));
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(_16);
	...
	ZEPHIR_CALL_FUNCTION(NULL, "define", &_6, 35, &_13, _17, ZEPHIR_GLOBAL(global_true));
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(_18);
	...
	ZEPHIR_CALL_FUNCTION(NULL, "define", &_6, 35, &_13, _19, ZEPHIR_GLOBAL(global_true));
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(PhalconPlus_Bootstrap, setModule) {
	...
	ZEPHIR_CALL_FUNCTION(&diff, "array_diff_key", NULL, 37, _0, module);
	zephir_check_call_status();
...
PHP_METHOD(PhalconPlus_Bootstrap, initConf) {
	...
	ZEPHIR_CALL_FUNCTION(&_1, "is_file", &_2, 38, globalConfPath);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&_6, this_ptr, "load", &_7, 39, globalConfPath);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_10, "is_file", &_2, 38, moduleConfPath);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&_13, this_ptr, "load", &_7, 39, moduleConfPath);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(NULL, "define", NULL, 35, &_30, _29, ZEPHIR_GLOBAL(global_true));
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "setmodule", NULL, 40, module);
	zephir_check_call_status();
...
PHP_METHOD(PhalconPlus_Bootstrap, exec) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "initconf", NULL, 41);
	zephir_check_call_status();
...
PHP_METHOD(PhalconPlus_Bootstrap, execModule) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "load", NULL, 39, _6);
	zephir_check_call_status();
...
PHP_METHOD(PhalconPlus_Bootstrap, execSrv) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "load", NULL, 39, _4);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(NULL, backendSrv, "__construct", NULL, 43, _11);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(_12);
...
PHP_METHOD(PhalconPlus_Bootstrap, dependModule) {
	...
	ZEPHIR_CALL_FUNCTION(&_2, "is_file", NULL, 38, moduleConfPath);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_VAR(moduleConf);
	object_init_ex(moduleConf, zephir_get_internal_ce(SS("phalcon\\config") TSRMLS_CC));
	ZEPHIR_CALL_METHOD(&_5, this_ptr, "load", NULL, 39, moduleConfPath);
	zephir_check_call_status();
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "setconfig", NULL, 44, moduleConf);
	zephir_check_call_status();
...
PHP_METHOD(PhalconPlus_Bootstrap, load) {
	...
	ZEPHIR_MAKE_REF(_0);
	ZEPHIR_CALL_FUNCTION(NULL, "extract", NULL, 45, _0);
	ZEPHIR_UNREF(_0);
	zephir_check_call_status();
