...
ZEPHIR_INIT_CLASS(PhalconPlus_App_Handler_Module) {
	...
	ZEPHIR_REGISTER_CLASS_EX(PhalconPlus\\App\\Handler, Module, phalconplus, app_handler_module, zephir_get_internal_ce(SL("phalcon\\di\\injectable")), phalconplus_app_handler_module_method_entry, 0);

	zend_declare_property_null(phalconplus_app_handler_module_ce, SL("app"), ZEND_ACC_PROTECTED);

	zend_declare_property_null(phalconplus_app_handler_module_ce, SL("handler"), ZEND_ACC_PROTECTED);

	zend_declare_property_bool(phalconplus_app_handler_module_ce, SL("autoHandle"), 1, ZEND_ACC_PROTECTED);
