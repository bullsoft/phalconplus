...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalconplus_app_app_getconfig, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalconplus_app_app_handle, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_phalconplus_app_app_setdefaultmodule, 0, 1, Phalcon\\Application\\AbstractApplication, 0)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalconplus_app_app_zephir_init_properties_phalconplus_app_app, 0, 0, 0)
ZEND_END_ARG_INFO()

ZEPHIR_INIT_FUNCS(phalconplus_app_app_method_entry) {
#if PHP_VERSION_ID >= 80000
	PHP_ME(PhalconPlus_App_App, getConfig, arginfo_phalconplus_app_app_getconfig, ZEND_ACC_PUBLIC)
#else
...
#if PHP_VERSION_ID >= 80000
	PHP_ME(PhalconPlus_App_App, handle, arginfo_phalconplus_app_app_handle, ZEND_ACC_PUBLIC)
#else
