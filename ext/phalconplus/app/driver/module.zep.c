...
ZEPHIR_INIT_CLASS(PhalconPlus_App_Driver_Module) {
	...
	ZEPHIR_REGISTER_CLASS_EX(PhalconPlus\\App\\Driver, Module, phalconplus, app_driver_module, zephir_get_internal_ce(SL("phalcon\\di\\injectable")), phalconplus_app_driver_module_method_entry, 0);

	zend_declare_property_null(phalconplus_app_driver_module_ce, SL("app"), ZEND_ACC_PROTECTED);
