...
PHP_METHOD(PhalconPlus_Curl_Curl, setBaseUrl) {
	...
	if (_3) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalconplus_curl_exception_ce, "Base Url should start with http:// or https://", "phalconplus/Curl/Curl.zep", 98);
		return;
	}
...
PHP_METHOD(PhalconPlus_Curl_Curl, buildUrl) {
	...
	if (_3) {
		zephir_read_property(&_6$$3, this_ptr, ZEND_STRL("baseUrl"), PH_NOISY_CC | PH_READONLY);
	...
	ZEPHIR_CALL_FUNCTION(&parts, "parse_url", NULL, 86, &url);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&queryString);
	ZVAL_STRING(&queryString, "");
	_8 = zephir_array_isset_string(&parts, SL("query"));
	if (_8) {
		zephir_array_fetch_string(&_9, &parts, SL("query"), PH_NOISY | PH_READONLY, "phalconplus/Curl/Curl.zep", 124);
		_8 = zephir_is_true(&_9);
	}
	ZEPHIR_INIT_NVAR(&queryString);
	if (_8) {
		zephir_array_fetch_string(&_10$$5, &parts, SL("query"), PH_NOISY | PH_READONLY, "phalconplus/Curl/Curl.zep", 125);
		ZEPHIR_CALL_FUNCTION(&_11$$5, "http_build_query", &_12, 87, &query);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_13$$5);
		ZEPHIR_CONCAT_VVSV(&_13$$5, &queryString, &_10$$5, "&", &_11$$5);
		ZEPHIR_CPY_WRT(&queryString, &_13$$5);
	} else {
		ZEPHIR_CALL_FUNCTION(&_14$$6, "http_build_query", &_12, 87, &query);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_15$$6);
		ZEPHIR_CONCAT_VV(&_15$$6, &queryString, &_14$$6);
		ZEPHIR_CPY_WRT(&queryString, &_15$$6);
	}
	zephir_array_fetch_string(&_16, &parts, SL("scheme"), PH_NOISY | PH_READONLY, "phalconplus/Curl/Curl.zep", 130);
	zephir_array_fetch_string(&_17, &parts, SL("host"), PH_NOISY | PH_READONLY, "phalconplus/Curl/Curl.zep", 130);
	ZEPHIR_INIT_VAR(&retUrl);
	ZEPHIR_CONCAT_VSV(&retUrl, &_16, "://", &_17);
	if (zephir_array_isset_string(&parts, SL("port"))) {
		zephir_array_fetch_string(&_18$$7, &parts, SL("port"), PH_NOISY | PH_READONLY, "phalconplus/Curl/Curl.zep", 132);
	...
	if (zephir_array_isset_string(&parts, SL("path"))) {
		zephir_array_fetch_string(&_20$$8, &parts, SL("path"), PH_NOISY | PH_READONLY, "phalconplus/Curl/Curl.zep", 135);
...
PHP_METHOD(PhalconPlus_Curl_Curl, newRequest) {
	...
	ZEPHIR_CALL_METHOD(NULL, &request, "__construct", NULL, 88, this_ptr);
	zephir_check_call_status();
	...
	if (zephir_is_true(&_0)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &request, "setheaders", NULL, 89, &_1$$3);
		zephir_check_call_status();
	}
	...
	if (zephir_is_true(&_2)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &request, "setoptions", NULL, 90, &_3$$4);
		zephir_check_call_status();
	}
	ZEPHIR_CALL_METHOD(NULL, &request, "setmethod", NULL, 91, &method);
	zephir_check_call_status();
	_5 = zephir_fetch_class_str_ex(SL("Phalcon\\Text"), ZEND_FETCH_CLASS_AUTO);
	ZEPHIR_INIT_VAR(&_6);
	ZVAL_STRING(&_6, "http://");
	...
	if (_7) {
		zephir_read_property(&_10$$5, this_ptr, ZEND_STRL("baseUrl"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_INIT_VAR(&_11$$5);
		ZEPHIR_CONCAT_VV(&_11$$5, &_10$$5, &url);
		zephir_get_strval(&url, &_11$$5);
	}
	ZEPHIR_CALL_METHOD(NULL, &request, "seturl", NULL, 92, &url);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, &request, "setdata", NULL, 93, data);
	zephir_check_call_status();
	ZVAL_LONG(&_12, encoding);
	ZEPHIR_CALL_METHOD(NULL, &request, "setencoding", NULL, 94, &_12);
	zephir_check_call_status();
...
PHP_METHOD(PhalconPlus_Curl_Curl, prepareRequest) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "curl_init", NULL, 95);
	zephir_check_call_status();
	...
	ZVAL_LONG(&_2, 19913);
	ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_3, 96, &_1, &_2, &__$true);
	zephir_check_call_status();
	zephir_read_property(&_2, this_ptr, ZEND_STRL("ch"), PH_NOISY_CC | PH_READONLY);
	ZVAL_LONG(&_4, 42);
	ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_3, 96, &_2, &_4, &__$true);
	zephir_check_call_status();
	...
	if (zephir_is_true(&auth)) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_3, 96, &_5$$3, &_6$$3, &auth);
		zephir_check_call_status();
	}
	...
	zephir_check_call_status();
	ZVAL_LONG(&_8, 10002);
	ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_3, 96, &_4, &_8, &_7);
	zephir_check_call_status();
	...
	if (!(ZEPHIR_IS_EMPTY(&options))) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt_array", NULL, 97, &_9$$4, &options);
		zephir_check_call_status();
	}
	...
	ZVAL_LONG(&_11, 10036);
	ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_3, 96, &_8, &_11, &_10);
	zephir_check_call_status();
	...
	zephir_check_call_status();
	ZVAL_LONG(&_13, 10023);
	ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_3, 96, &_11, &_13, &_12);
	zephir_check_call_status();
	...
	if (zephir_is_true(&_14)) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_3, 96, &_15$$5, &_17$$5, &_16$$5);
		zephir_check_call_status();
	}
	if (ZEPHIR_IS_STRING_IDENTICAL(&method, "head")) {
		zephir_read_property(&_18$$6, this_ptr, ZEND_STRL("ch"), PH_NOISY_CC | PH_READONLY);
		ZVAL_LONG(&_19$$6, 44);
		ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_3, 96, &_18$$6, &_19$$6, &__$true);
		zephir_check_call_status();
	}
	RETURN_THIS();
...
PHP_METHOD(PhalconPlus_Curl_Curl, sendRequest) {
	...
	if (ZEPHIR_IS_FALSE_IDENTICAL(&result)) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "curl_close", &_4, 101, &_3$$3);
		zephir_check_call_status();
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_5$$3, "phalconplus/Curl/Curl.zep", 248);
		ZEPHIR_MM_RESTORE();
		return;
	}
	...
	zephir_check_call_status();
	zephir_read_property(&_8, this_ptr, ZEND_STRL("ch"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_FUNCTION(NULL, "curl_close", &_4, 101, &_8);
	zephir_check_call_status();
...
PHP_METHOD(PhalconPlus_Curl_Curl, createResponseObject) {
	...
	zephir_read_property(&_0, this_ptr, ZEND_STRL("ch"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_FUNCTION(&info, "curl_getinfo", &_1, 102, &_0);
	zephir_check_call_status();
	zephir_read_property(&_2, this_ptr, ZEND_STRL("ch"), PH_NOISY_CC | PH_READONLY);
	ZVAL_LONG(&_3, 2097163);
	ZEPHIR_CALL_FUNCTION(&headerSize, "curl_getinfo", &_1, 102, &_2, &_3);
	zephir_check_call_status();
	ZVAL_LONG(&_3, 0);
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 103, &body, &headers, &info);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(PhalconPlus_Curl_Curl, __call) {
	...
	if (!(zephir_array_key_exists(&_10, &method))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_11$$5, "__construct", NULL, 104, &msg);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_11$$5, "phalconplus/Curl/Curl.zep", 293);
		ZEPHIR_MM_RESTORE();
		return;
	}
	if (!(zephir_array_isset_long(&args, 0))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_12$$6, "__construct", NULL, 104, &msg);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_12$$6, "phalconplus/Curl/Curl.zep", 297);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_OBS_VAR(&url);
	zephir_array_fetch_long(&url, &args, 0, PH_NOISY, "phalconplus/Curl/Curl.zep", 299);
	if (zephir_array_isset_long(&args, 1)) {
		ZEPHIR_OBS_NVAR(&data);
		zephir_array_fetch_long(&data, &args, 1, PH_NOISY, "phalconplus/Curl/Curl.zep", 301);
	}
	...
	if (zephir_array_isset_long(&args, 2)) {
		...
		zephir_array_fetch_long(&_13$$8, &args, 2, PH_NOISY, "phalconplus/Curl/Curl.zep", 308);
		ZEPHIR_OBS_VAR(&_14$$8);
		zephir_array_fetch_long(&_14$$8, &args, 2, PH_NOISY, "phalconplus/Curl/Curl.zep", 310);
		if (Z_TYPE_P(&_13$$8) == IS_STRING) {
			zephir_array_fetch_long(&_15$$9, &args, 2, PH_NOISY | PH_READONLY, "phalconplus/Curl/Curl.zep", 309);
			ZEPHIR_CALL_METHOD(NULL, &request, "setheader", NULL, 0, &_15$$9);
			zephir_check_call_status();
		} else if (Z_TYPE_P(&_14$$8) == IS_ARRAY) {
			zephir_array_fetch_long(&_16$$10, &args, 2, PH_NOISY | PH_READONLY, "phalconplus/Curl/Curl.zep", 312);
			zephir_is_iterable(&_16$$10, 0, "phalconplus/Curl/Curl.zep", 315);
