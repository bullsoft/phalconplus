...
PHP_METHOD(PhalconPlus_Curl_Curl, createResponseObject) {
	...
	zephir_read_property(&_0, this_ptr, ZEND_STRL("ch"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_FUNCTION(&info, "curl_getinfo", &_1, 100, &_0);
	zephir_check_call_status();
	zephir_read_property(&_2, this_ptr, ZEND_STRL("ch"), PH_NOISY_CC | PH_READONLY);
	ZVAL_LONG(&_3, 2097163);
	ZEPHIR_CALL_FUNCTION(&headerSize, "curl_getinfo", &_1, 100, &_2, &_3);
	zephir_check_call_status();
	ZVAL_LONG(&_3, 0);
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 101, &body, &headers, &info);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(PhalconPlus_Curl_Curl, __call) {
	...
	if (!(zephir_array_key_exists(&_10, &method))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_11$$5, "__construct", NULL, 102, &msg);
		zephir_check_call_status();
	...
	if (!(zephir_array_isset_long(&args, 0))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_12$$6, "__construct", NULL, 102, &msg);
		zephir_check_call_status();
