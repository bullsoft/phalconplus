...
#define ZEPHIR_CONCAT_SSSS(result, op1, op2, op3, op4) \
	 zephir_concat_ssss(&result, op1, sizeof(op1)-1, op2, sizeof(op2)-1, op3, sizeof(op3)-1, op4, sizeof(op4)-1, 0 TSRMLS_CC);
#define ZEPHIR_SCONCAT_SSSS(result, op1, op2, op3, op4) \
	 zephir_concat_ssss(&result, op1, sizeof(op1)-1, op2, sizeof(op2)-1, op3, sizeof(op3)-1, op4, sizeof(op4)-1, 1 TSRMLS_CC);
...
#define ZEPHIR_CONCAT_VVSS(result, op1, op2, op3, op4) \
	 zephir_concat_vvss(&result, op1, op2, op3, sizeof(op3)-1, op4, sizeof(op4)-1, 0 TSRMLS_CC);
#define ZEPHIR_SCONCAT_VVSS(result, op1, op2, op3, op4) \
	 zephir_concat_vvss(&result, op1, op2, op3, sizeof(op3)-1, op4, sizeof(op4)-1, 1 TSRMLS_CC);
...
void zephir_concat_ssss(zval **result, const char *op1, zend_uint op1_len, const char *op2, zend_uint op2_len, const char *op3, zend_uint op3_len, const char *op4, zend_uint op4_len, int self_var TSRMLS_DC);
