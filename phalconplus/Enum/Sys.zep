...
final class Sys extends AbstractEnum
{
    ...
    public static function initApp(<SuperApp> app)
    {
        if is_null(self::app) {
            let self::app = app;
        }
    ...
    {
        return self::primaryModuleDir . Sys::DS;
    }

    // -> {APP_ROOT_DIR}
    public static function getRootDir() -> string
    {
        return self::rootDir . Sys::DS;
    }
    ...
    public static function getModuleConfigPath(string moduleDir)
    {
        ...
        let confPrefix = implode(Sys::DS, [
            rtrim(moduleDir, Sys::DS),
            Sys::APP_NAME,
            Sys::CONF_NAME,
            ""
        ]);
    ...
    public static function load(var filePath)
    {
